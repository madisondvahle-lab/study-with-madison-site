  ...
  return (
    <main>
      ...
      <section className="intensive">
        ...
        <ul><li><span>✓</span> Twelve private 60-minute Zoom sessions</li><li><span>✓</span> Personalized test-day roadmap, updated as you progress</li><li><span>✓</span> 24/7 access to your study plan, priorities, and targeted resources</li><li><span>✓</span> Priority booking with preferred coaching-session availability</li><li><span>✓</span> Flexible rescheduling and complimentary cancellation options</li><li><span>✓</span> Shared review of assessments, trends, and weak areas</li><li><span>✓</span> Priority coaching support between sessions, with replies within 24 hours</li></ul>
      </section>
